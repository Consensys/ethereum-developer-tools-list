...
Many thanks to the ~100 contributors including [@corbinpage](https://twitter.com/corbpage) and [@pakaplace](https://twitter.com/Parker_Place) of [ConsenSys Codefi](https://consensys.net/codefi/) for curating, and @jpantunes for restructuring the list in a more logical way.
...
* [Brownie](https://github.com/eth-brownie/brownie) - Brownie is a Python framework for deploying, testing and interacting with Ethereum smart contracts.
...
* [Yul](https://docs.soliditylang.org/en/latest/yul.html) - is an intermediate programming language that is compiled to bytecode for addressing the needs of different backends.
...
* [Dapp](https://dapp.tools/) - Framework for DApp development, successor to DApple
...
* [OpenZeppelin Defender](https://openzeppelin.com/defender/) - A suite of tools to help you develop, compile, upgrade, deploy and interact with smart contracts.
...
* [Azure Blockchain Dev Kit for Ethereum for VSCode](https://github.com/azure-samples/blockchain-devkit/tree/master/) - Samples of how to integrate, connect and use devops to interact with Azure blockchain
...
* [Besu Private Network](https://besu.hyperledger.org/en/stable/private-networks/tutorials/azure/) - Run a private network of Besu nodes in a Docker container
  * [Tessera](https://docs.tessera.consensys.net/en/stable/) - Component for performing private transactions by ConsenSys
...
* [Alchemy](https://www.alchemy.com/) - Blockchain Developer Platform, Ethereum API, and Node Service (Mainnet, Ropsten, Rinkeby, Goerli, Kovan)
...
* [Ethereumjs](https://github.com/ethereumjs/) - A collection of utility functions for Ethereum like [ethereumjs-util](https://github.com/ethereumjs/ethereumjs-monorepo/tree/master/packages/util) and [ethereumjs-tx](https://github.com/ethereumjs/ethereumjs-monorepo/tree/master/packages/tx)
* [Alchemy-SDK](https://github.com/alchemyplatform/alchemy-sdk-js) - Javascript Web3 wrapper with automatic retries, access to [Alchemy's enhanced APIs](https://docs.alchemy.com/reference/sdk-websockets-endpoints#getting-started), and robust websocket connections. 
...
* [Tasit SDK](https://github.com/tasitlabs/tasit-sdk) - A JavaScript SDK for making native mobile Ethereum dapps using React Native
...
* [Subproviders](https://github.com/0xProject/tools/tree/development/subproviders) - Several useful subproviders to use in conjunction with [Web3-provider-engine](https://github.com/MetaMask/web3-provider-engine) (including a LedgerSubprovider for adding Ledger hardware wallet support to your dApp)
...
* [Chainify](https://github.com/liquality/chainify) - Communicate with different blockchains (including Ethereum) using a single interface.
...
* [Magic](https://magic.link/) - A simple to use SDK to build web3 dApps without extensions or downloads.
...
* [Scaffold-ETH](https://github.com/scaffold-eth/scaffold-eth) - Beginner friendly forkable github for getting started building smart contracts. 
* [Web3-Onboard](https://onboard.blocknative.com/) - Deliver real-time notifications to your users. With built-in support for Speed-Ups and Cancels, Blocknative Onboard helps users transact with confidence.
...
* [Eventeum](https://github.com/eventeum/eventeum) - A bridge between Ethereum smart contract events and backend microservices
...
* [Ethereum Logging Framework](https://github.com/ChrisKlinkmueller/Ethereum-Logging-Framework) - provides advanced logging capabilities for Ethereum applications and networks including a query language, query processor, and logging code generation
* [Watchdata](https://watchdata.io) - Provide simple and reliable API access to Ethereum blockchain
...
** [Blazor/Blockchain Explorer](https://github.com/Nethereum/Nethereum-Explorer-Wallet-Template-Blazor) - Wasm blockchain explorer (functional sample)
* [Local Raiden](https://github.com/ConsenSysMesh/Local-Raiden) - Run a local Raiden network in docker containers for demo and testing purposes
* [Private networks deployment scripts](https://github.com/ConsenSys/private-networks-deployment-scripts) - Out-of-the-box deployment scripts for private PoA networks
* [Local Ethereum Network](https://github.com/ConsenSysMesh/local_ethereum_network) - Out-of-the-box deployment scripts for private PoW networks
* [Kaleido](https://kaleido.io/) - Use Kaleido for spinning up a consortium blockchain network. Great for PoCs and testing
...
* [web3-react](https://github.com/Uniswap/web3-react) - React framework for building single-page Ethereum dApps
...
* [ABI-gen](https://github.com/0xProject/tools/tree/development/abi-gen) - Generate Typescript contract wrappers from contract ABI's.
...
* [Dappsys: Safe, simple, and flexible Ethereum contract building blocks](https://github.com/dapphub/dappsys)
    ...
    * provides building blocks for the [MakerDAO](https://github.com/daifoundation/maker-otc) or [The TAO](https://github.com/ryepdx/the-tao)
...
* [aragonOS: A smart contract framework for building DAOs, Dapps and protocols](https://hack.aragon.org/developers/tools/aragonos)
...
* [Clean Contracts - A guide to writing clean code](https://www.useweb3.xyz/guides/clean-contracts)

##### Upgradeability
* [Blog von Elena Dimitrova, Dev at colony.io](https://blog.colony.io/author/elena/)
    * https://blog.colony.io/writing-more-robust-smart-contracts-99ad0a11e948
    * https://blog.colony.io/writing-upgradeable-contracts-in-solidity-6743f0eecc88
* [Aragon research blog](https://blog.aragon.org/research/)
...
* [Ethereumjs](https://github.com/ethereumjs/ethereumjs-monorepo/tree/master/packages/client) - JS client using [ethereumjs-vm](https://github.com/ethereumjs/ethereumjs-monorepo)
...
* [Quorum](https://github.com/ConsenSys/quorum) - A permissioned implementation of Ethereum supporting data privacy by ConsenSys
...
* [Swarm](https://www.ethswarm.org/) - Distributed storage platform and content distribution service, a native base layer service of the Ethereum web3 stack
* [Infura](https://infura.io/) - A managed IPFS API Gateway and pinning service
* [Ceramic Network](https://ceramic.network/) - An api for user controlled, distrubuted storage. Built on top of IPFS.
...
#### Messaging
* [Waku](https://waku.org/) - Communication protocol for DApps to communicate with each other
...
### Testing Tools
* [Solidity code coverage](https://github.com/0xProject/tools/tree/development/sol-coverage) - Solidity code coverage tool
...
* [Waffle Mock](https://github.com/TrueFiEng/Waffle/tree/master/waffle-mock-contract) - a library for mocking smart contract dependencies during unit testing.
...
* [pytest-cobra](https://github.com/meherett/pytest-solidity) - PyTest plugin for testing smart contracts for Ethereum blockchain.
...
* [Oyente](https://github.com/enzymefinance/oyente) - Alternative static smart contract security analysis
* [Securify2](https://github.com/eth-sri/securify2) - Security scanner for Ethereum smart contracts
...
* [BlockScout](https://github.com/blockscout/blockscout) - A tool for inspecting and analyzing EVM based blockchains. The only full featured blockchain explorer for Ethereum networks.
...
* [Alchemy Notify](https://docs.alchemy.com/reference/notify-api-quickstart) - Notifications for mined and dropped transactions, gas price changes, and address activity for desired addresses. 
...
* [InfStones BlockWatch](https://infstones.com/blockwatch) - Set up alarms to monitor node status for resource utilization. Incorporate notifications for SMS, Slack, phone calls, and emails.

### Other Miscellaneous Tools
* [aragonPM](https://hack.aragon.org/developers/tools/aragonpm) - a decentralized package manager powered by aragonOS and Ethereum. aragonPM enables decentralized governance over package upgrades, removing centralized points of failure.
...
* [RLP](https://github.com/ethereumjs/ethereumjs-monorepo/tree/master/packages/rlp) - Recursive Length Prefix Encoding in JavaScript
...
* [truffle-flattener](https://github.com/NomicFoundation/truffle-flattener) - Concats solidity files developed under Truffle with all of their dependencies
* [Decode](https://github.com/hacker-DOM/decode) - npm package which parses tx's submitted to a local testrpc node to make them more readable and easier to understand
* [TypeChain](https://github.com/dethcrypto/TypeChain) - Typescript bindings for Ethereum smartcontracts
* [EthSum](https://ethsum.netlify.app) - A Simple Ethereum Address Checksum Tool
...
* [Blocknative Gas Platform](https://www.blocknative.com/gas-platform) — Gas estimation for builders, by builders. Gas Platform harnesses Blocknative's real-time mempool data infrastructure to accurately and consistently estimate Ethereum transaction fees. This provides builders and traders with an up-to-the-moment gas fee API. 
* [ETH Gas.watch](https://www.useweb3.xyz/gas) - A gas price watcher with email notifications on price change
...
* [OpenZeppelin](https://github.com/OpenZeppelin/openzeppelin-contracts) - Contains tested reusable smart contracts like SafeMath and OpenZeppelin upgradeable contracts [library](https://github.com/OpenZeppelin/openzeppelin-upgrades)
...
* [Aragon](https://github.com/aragon/client) - DAO protocol. Contains [aragonOS smart contract framework](https://github.com/aragon/aragonOS) with focus on upgradeability and governance
...
* [Plasma MVP](https://github.com/omgnetwork/plasma-contracts) - OmiseGO's research implementation of Minimal Viable Plasma
...
* [POA Network](https://www.poa.network/)
  * [Omni Bridge UI](https://github.com/omni/bridge-ui)
  * [Omni Bridge Contracts](https://github.com/omni/tokenbridge-contracts)
...
* [aragonUI](https://hack.aragon.org/developers/tools/aragonui) - A React library including Dapp components
...
* [Metamask UI](https://github.com/MetaMask/metamask-extension/tree/develop/ui) - Metamask React Components
...
* [Rimble Design System](https://github.com/ConsenSysMesh/rimble-ui) - Adaptable components and design standards for decentralized applications.

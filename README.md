...
Many thanks to the ~100 contributors including [@corbpage](https://x.com/corbpage) and [@pakaplace](https://x.com/Parker_Place) of [Meridio](https://x.com/meridiore) for curating, and [@jpantunes](https://github.com/jpantunes?tab=overview&from=2025-01-01&to=2025-01-07) for restructuring the list in a more logical way.

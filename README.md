...
* [sbt-ethereum](https://sbt-ethereum.io/) - A tab-completely, text-based console for smart-contract interaction and development, including wallet and ABI management, ENS support, and advanced Scala integration.
